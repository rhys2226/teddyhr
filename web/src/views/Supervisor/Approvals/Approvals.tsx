    ...
    return (
        <div>
            <div className="col-md-12 my-4">
                ...
                <p className="mb-3 text-muted">Displaying List of Approvals in descending order</p>
                    ...
                    <div className="card-body">
                        ...
                        <table className="table table-borderless table-hover">
                            ...
                            <tbody>
                                ...
                                <ApprovalsPlaceholder show={document.length !== 0 ? false : true} />
                                {
                                    document.map( () => (
                                        <tr>
                                            ...
                                            <td>
                                                <button className="btn btn-md btn-info dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span className="text-muted sr-only">Action</span>
                                                </button>
                                                <div className="dropdown-menu dropdown-menu-right">
                                                    <button
                                                        onClick={() => {
                                                            Fire( 'Virtually Sign Document?', 'Are you sure you want to Sign this Document?', 'info', () => {
                                                                Alert( 'Document Succesfully Signed', '', 'success' )
                                                            } )
                                                        }}
                                                        className="dropdown-item" > Sign</button>
                                                    <button
                                                        data-toggle="modal" data-target=".modal-full"
                                                        className="dropdown-item" > View Document</button>
                                                    <button
                                                        onClick={() => {
                                                            Fire( 'Reject Document?', 'Are you sure you want to Reject this Document?', 'warning', () => {
                                                                Alert( 'Document Succesfully Rejected', '', 'success' )
                                                            } )
                                                        }}
