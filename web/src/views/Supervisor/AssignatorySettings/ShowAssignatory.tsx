        ...
        <div>
            <table className="table text-center">
                <thead>
                    <tr>
                        <th>Order</th>
                        <th><i className="fe fe-user"></i></th>
                        <th>Name</th>
                        <th>Position</th>
                        <th>Office</th>
                        <th></th>
                ...
                <tbody>
                    <ShowAssignatoryPlaceholder show={assignatories.length !== 0 ? false : true} />
                    {
                        assignatories.map( () => (
                            <tr>
                                <td>1</td>
                                ...
                                <td>
                                    <button
                                        onClick={() => {
                                            Fire( 'Remove Assignatory?', 'Are you sure you want to Remove  Assignatory?', 'warning', () => {
