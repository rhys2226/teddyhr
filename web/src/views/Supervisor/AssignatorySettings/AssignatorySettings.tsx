    ...
    return (
        <div>
            <div className="col-md-12 my-4">
                ...
                <p className="mb-3 text-muted">Assign assignatories to each document here</p>
                        ...
                        <table className="table text-center">
                            <thead className="table-dark table-striped">
                                <tr>
                                    ...
                                    <th className="text-primary">Assignatories</th>
                                    <th>
                                        <button
                                            data-toggle='modal'
                                            data-target=".slide-modal"
                                            className="btn btn-outline-primary">Add Approvals</button>

                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <AssignatoryPlaceholder show={assignatories.length !== 0 ? false : true} />
                                {
                                    assignatories.map( () => (
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div className="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <button
                                                        ...
                                                        role="butoon" className="dropdown-item" >Show Assignatories</button>
                                                </div>
                                            </td>
                                        </tr>
            ...
            <SlideModal
                ...
                buttonName="Add"
                callback={() => {
                    Fire( 'Add Assignatory?', 'Are you sure you want to Add an Assignatory?', 'info', () => {
