        ...
        <div>
            ...
            <div className="box row sub-title m-0 p-0 m-0 p-0">
                <div className="col-md-5 row sub-title m-0 p-0 d-flex aic jcc nbb nbt">
                    <p className="m-0 mb-0 pb-0 text-center ">30. &nbsp;TITLE OF LEARNING AND DEVELOPMENT INTERVENTIONS/TRAINING PROGRAMS <br />(Write in full)</p>
                </div>
                ...
                <div className="col-md-1 row sub-title m-0 p-0 d-flex aic jcc nbr nbb nbt">
                    <p className="m-0 mb-0 pb-0 text-center ">&nbsp;NUMBER OF HOURS</p>
                </div>

                <div className="col-md-1 row sub-title m-0 p-0 d-flex aic jcc nbr nbb nbt">
                    <p className="m-0 mb-0 pb-0 text-center ">&nbsp;Type of LD <br /> ( Managerial/<br /> Supervisory/<br />Technical/etc)</p>
                </div>

                <div className="col-md-3 row sub-title m-0 p-0 d-flex aic jcc nbb nbt">
                    <p className="m-0 mb-0 pb-0 text-center ">&nbsp;CONDUCTED/ SPONSORED BY <br />(Write in full/Do not abbreviate)</p>
                </div>

                {
                    props.LearningAndDevelopments.map( ( development: LearningAndDevelopments ) => (
                        <>
                            ...
                            <div className="col-md-1 row m-0 p-0 d-flex aic nbr jcc bt bl   bg-white">
                                <p className="m-0 mb-0 pb-0 text-center  bold underlined p-1"> {development.Hours}</p>
                            </div>

                            <div className="col-md-1 row m-0 p-0 d-flex aic nbr jcc bt bl  bg-white">
                                <p className="m-0 mb-0 pb-0 text-center  bold underlined p-1"> {development.Type}</p>
                            </div>

                            <div className="col-md-3 row m-0 p-0 d-flex aic nbr jcc bt bl bg-white">
                                <p className="m-0 mb-0 pb-0 text-center  bold underlined p-1"> {development.SponsoredBy}</p>
                            </div>
                        </>
                    ) )
                }
