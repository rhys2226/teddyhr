            ...
            <div className="PDSBorder" >
                ...
                <div className="box row sub-title m-0 p-0 m-0 p-0">
                    <div className="col-md-7 br pt-1">
                        <p className="m-0">Are you related by consanguinity or affinity to the appointing or recommending authority, or to the</p>
                ...
                <div className="box row sub-title m-0 p-0 m-0 p-0">
                    <div className="col-md-7 br pt-1">
                        <p className="mb-5">a. Have you ever been found guilty of any administrative offense?</p>
                        <br />
                ...
                <div className="box row sub-title m-0 p-0 m-0 p-0">
                    <div className="col-md-7 br pt-1">
                        <p className="m-0">Have you ever been convicted of any crime or violation of any law, decree, ordinance or regulation by any court or tribunal?</p>
                    </div>
                    <div className="col-md-5 bg-white row p-0 m-0 pt-1">
                        <div className="col-md-12 row m-0 p-0" >
                ...
                <div className="box row sub-title m-0 p-0 m-0 p-0">
                    <div className="col-md-7 br pt-1">
                        <p className="m-0">Have you ever been separated from the service in any of the following modes: resignation, retirement, dropped from the rolls, dismissal, termination, end of term, finished contract or phased out (abolition) in the public or private sector?</p>
                    </div>
                    <div className="col-md-5 bg-white row p-0 m-0 pt-2">
                        ...
                        <div className="col-md-12 row m-0 p-0 pl-3 pt-1 mt-2">
                ...
                <div className="box row sub-title m-0 p-0 m-0 p-0">
                    <div className="col-md-7 br pt-1">
                        <p className="m-0">a. Have you ever been a candidate in a national or local election held within the last year (except Barangay election)?</p>
                ...
                <div className="box row sub-title m-0 p-0 m-0 p-0">
                    <div className="col-md-7 br pt-1">
                        <p className="m-0">Pursuant to: (a) Indigenous People's Act (RA 8371); (b) Magna Carta for Disabled Persons (RA 7277); and (c) Solo Parents Welfare Act of 2000 (RA 8972), please answer the following items:</p>
