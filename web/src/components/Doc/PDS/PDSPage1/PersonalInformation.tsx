    ...
    return (
        <div style={{ borderTop: '2px solid black' }}>
            ...
            <div className=" row m-0 p-0">
                <div className="col-md-3 sub-title m-0 p-1 pl-3 nbl nbb" style={{ flex: '0 0 20.9%' }}>
                ...
                <div className="col-md-9  m-0 p-0 bt " style={{ flex: '0 0 79.1%', maxWidth: '100%' }}>
                    <p className="w-100 border-bottom pt-2 p-1 pl-3 m-0 pl-2  bold underlined">{user.Last}</p>
                    <p className="w-100 border-bottom m-0 row">
                        <div className="col-md-8  pt-2 m-0 p-1 pl-3 bold underlined">{user.First} </div>
                    ...
                    <p className="w-100 pl-3 pt-1  m-0 bold underlined">{user.Middle}</p>
                </div>
            </div>
            <div className="border-bottom row m-0 p-0">
                ...
                <div className="col-md-5 m-0 p-0 row">
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb pt-1 ">
                        <p className="m-0 mb-3 p-1 pl-3">&nbsp; 3.   DATE OF BIRTH <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(mm/dd/yyyy)
                        </p>
                    </div>
                    <div className="col-md-6 m-0 pl-2 pb-2 box nbl nbr d-flex aic  nbb" >
                        <p className="m-0 p-0 bold underlined pl-2">{toDate( personal_information.DOB )}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="mt-0 p-0  m-0 p-1 pl-3">&nbsp; 4. PLACE OF BIRTH </p>
                    </div>
                    <div className="col-md-6 m-0 p-1 pl-3 border-bottom d-flex aic bt nbb">
                        <p className="m-0 p-0 bold underlined">Pototan</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="pt-1 m-0 p-1 pl-3">&nbsp; 5. SEX </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 pl-3 border-bottom d-flex aic bt  nbb">
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb">
                        <p className="p-1 pl-3">&nbsp; 6. CIVIL STATUS </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 pl-3 pt-3 pb-3 border-bottom aic bt  nbb">
                        <div className="d-flex w-100" style={{ transform: 'translate(0,-3px)' }}>
                            <div className="d-flex ml-1" style={{ flex: 1 }}>
                                <input disabled defaultChecked={personal_information.CivilStatus === 'Single'} className="m-0 checkbox" type="checkbox" />
                                <label className="m-0 " style={{ marginTop: '2px' }}>&nbsp; Single</label>
                            </div>
                            <div className="d-flex" style={{ flex: 1 }}>
                                <input disabled defaultChecked={personal_information.CivilStatus === 'Married'} className="m-0 checkbox" type="checkbox" />
                                <label className="m-0 " style={{ marginTop: '2px' }}>&nbsp; Married</label>
                            </div>
                        </div>
                        <div className="d-flex w-100">
                            <div className="d-flex ml-1" style={{ flex: 1 }}>
                                <input disabled defaultChecked={personal_information.CivilStatus === 'Widow'} className="m-0 checkbox" type="checkbox" />
                                <label className="m-0 " style={{ marginTop: '2px' }}>&nbsp; Widow</label>
                            </div>
                            <div className="d-flex" style={{ flex: 1 }}>
                                <input disabled defaultChecked={personal_information.CivilStatus === 'Separated'} className="m-0 checkbox" type="checkbox" />
                                <label className="m-0 " style={{ marginTop: '2px' }}>&nbsp; Separated</label>
                            </div>
                        </div>
                        <div className="d-flex w-100" style={{ transform: 'translate(0,3px)' }}>
                            <div className="d-flex ml-1" style={{ flex: 1 }}>
                                <input disabled defaultChecked={personal_information.CivilStatus === 'Others'} className="m-0 checkbox" type="checkbox" />
                                <label className="m-0 " style={{ marginTop: '2px' }}>&nbsp; Other/s</label>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="m-0 p-1 pl-3">&nbsp; 7. HEIGHT (m) </p>
                    </div>
                    <div className="col-md-6  m-0 p-1  border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.Height}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="m-0 p-0 pt-0 p-1 pl-3">&nbsp; 8. WEIGHT (kg) </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.Weight}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="m-0 p-0 pt-1 pb-1 p-1 pl-3">&nbsp; 9. BLOOD TYPE </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">Type {personal_information.BLOODTYPE}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="m-0 p-0 pt-1 pb-0 p-1 pl-3">&nbsp; 10. GSIS ID NO </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.GSIS}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="pt-1 m-0 p-1 pl-3">&nbsp; 11. PAG-IBIG ID NO </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.PAGIBIG}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="p-0 pt-1  m-0 p-1 pl-3">&nbsp; 12. PHILHEALTH NO </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.PHILHEALTH}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="pt-1 m-0 p-1 p-1 pl-3"> 13. SSS NO </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.SSS}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="pt-1 m-0 p-1 p-1 pl-3"> 14. TIN NO </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.TIN}</p>
                    </div>
                    <div className="col-md-6 sub-title m-0 p-0 nbl nbb d-flex aic bt">
                        <p className="pt-1 m-0 p-0 pl-1 p-1 pl-3"> 15. AGENCY EMPLOYEE NO  </p>
                    </div>
                    <div className="col-md-6  m-0 p-1 border-bottom d-flex aic bt  nbb">
                        <p className="m-0 p-1 pl-3 bold underlined">{personal_information.EmployeeNumber}</p>
                    </div>
                </div>
                {/* {right} */}
                <div className="col-md-7 m-0 p-0 row box nbr">
                    ...
                    <div className="col-md-7 m-0 p-1 pl-3 box nbr">
                        <div className="d-flex w-100 m-0">
                        ...
                        <select defaultValue={personal_information.Details} className="form-control m-0 mt-3" style={{ transform: 'translate(-7px,20px)scaleX(1.05)' }} >
                    ...
                    <div className="col-md-4 sub-title m-0 p-0 nbt">
                        ...
                        <p className="m-0 mb-3" style={{ transform: 'translate(3rem,4.8rem)' }}>&nbsp; ZIP CODE</p>
                    </div>
                    ...
                    <div className="col-md-4 sub-title m-0  p-0 nbt">
                        ...
                        <p className="m-0 mb-3" style={{ transform: 'translate(3rem,5.3rem)' }}>&nbsp; ZIP CODE</p>
                    </div>
                    <div className="col-md-8 border-bottom m-0 p-0 row">
                        <div className="col-md-12 border-bottom m-0 p-0">
                            <div className="d-flex m-0 pt-0">
