            ...
            <div className="border-bottom br row m-0 p-0 nbl">
                ...
                <div className="col-md-7 m-0 p-0 row " style={{ flex: '0 0 61.2%', maxWidth: '100%' }}>
                    <div className="col-md-6 sub-title m-0 p-0 ll nbl nbl nbb">
                        <p className="m-0 mb-2 mt-1 p-1 pl-3">&nbsp; 22.  SPOUSE'S SURNAME</p>
                        <p className="m-0 mb-2 ml-3 p-1 pl-3">&nbsp;   FIRST NAME</p>
                        <p className="m-0 mb-2 ml-3 p-1 pl-3">&nbsp;   MIDDLE NAME</p>
                    </div>
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 ll nbl nbl nbb  ">
                        <p className="m-0 mb-0 p-1 pl-3 p-1 pl-3">&nbsp;OCCUPATION</p>
                    </div>
                    <div className="col-md-6 m-0 p-0 row  lr">
                        <div className="col-md-12 m-0 p-0 row border-bottom br">
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 ll nbl nbl nbb">
                        <p className="m-0 mb-0 p-1  pl-3 p-1 pl-3">&nbsp;EMPLOYER/BUSINESS NAME</p>
                    </div>
                    <div className="col-md-6 m-0 p-0 row lr">
                        <div className="col-md-12 m-0 p-0 row border-bottom br">
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 ll nbl nbb nbb">
                        <p className="m-0 mb-0 p-1  pl-3 p-1 pl-3">&nbsp;BUSINESS ADDRESS</p>
                    </div>
                    <div className="col-md-6 m-0 p-0 row  lr">
                        <div className="col-md-12 m-0 p-0 row border-bottom br">
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 ll nb nbb nbl">
                        <p className="m-0 mb-0 p-1  pl-3 p-1 pl-3">&nbsp;TELEPHONE NO.</p>
                    </div>
                    <div className="col-md-6 m-0 p-0 row  lr">
                        <div className="col-md-12 m-0 p-0 row border-bottom br">
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 ll nbl ">
                        <p className="m-0 mb-2 mt-1 p-1 pl-3">&nbsp; 24.  FATHERS'S SURNAME</p>
                        <p className="m-0 mb-2 ml-3 p-1 pl-3">&nbsp;   FIRST NAME</p>
                        <p className="m-0 mb-2 ml-3 p-1 pl-3">&nbsp;   MIDDLE NAME</p>
                    </div>
                    <div className="col-md-6 m-0 p-0 row  lr">
                    ...
                    <div className="col-md-6 sub-title m-0 p-0 ll nbl nbr nbt">
                        <p className="m-0 mb-2 mt-1 p-1 pl-3">&nbsp; 25.  MOTHERS'S SURNAME</p>
                        <p className="m-0 mb-2 ml-3 p-1 pl-3">&nbsp;   FIRST NAME</p>
                        <p className="m-0 mb-2 ml-3 p-1 pl-3">&nbsp;   MIDDLE NAME</p>
                    </div>
                    <div className="col-md-6 m-0 p-0 row lr nbt">
                        <div className="col-md-12 m-0 p-1 pl-3 row border-bottom br nbl sub-title nbt">
                        </div>
